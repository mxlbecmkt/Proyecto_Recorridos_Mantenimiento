<?php 
    ...
    $pdf->Image('temp_chart_1.png', 70, 75, 120, 96, 'PNG');
    ...
    $pdf->MultiCell(40, 27, '[LOGO]', 1, 'C', 0, 0, 10, 10, true, 0, false, true, 27, 'M');
    $pdf->MultiCell(120, 27, 'LECTURAS DE HUMEDAD', 1, 'C', 0, 0, 50, 10, true, 0, false, true, 27, 'M');
    $pdf->MultiCell(30, 9, '[TEXT1]', 1, 'C', 0, 1, 170, 10, true, 0, false, true, 9, 'M');
    $pdf->MultiCell(30, 9, '[TEXT2]', 1, 'C', 0, 1, 170, 19, true, 0, false, true, 9, 'M');
    $pdf->MultiCell(30, 9, '[TEXT3]', 1, 'C', 0, 1, 170, 28, true, 0, false, true, 9, 'M');
    ...
    foreach ($registros as $registro){
        ...
        $sql = "SELECT * FROM lecturas WHERE lec_reg_num={$registro['reg_num']} AND lec_tipo_lec_id=8";
        $stmt = $conexion->prepare($sql);
        $stmt->execute();
        $lectura = $stmt->fetchAll(PDO::FETCH_ASSOC);
    ...
    $pdf->Image('temp_chart_2.png', 70, 75, 120, 96, 'PNG');
    ...
    unlink('temp_chart_1.png');
    unlink('temp_chart_2.png');
?>