<?php 
  ...
  //Recibir del menú de reporte mensual
  $tipo_servicio_id = 1;
  $servicio_id = 1;
  ...
  $pdf->MultiCell(120, 26, 'Registro Mensual de ' . $servicio[0]['tipo_ser_nombre'] . ' De Medidor ' . $servicio[0]['ser_medidor'], 1, 'C', 0, 0, 50, 10, true, 0, false, true, 26, 'M');
  ...
  $pdf->MultiCell(95, 5, 'Ubicación: ' . $mes, 1, 'C', 0, 0, 10, 41, true, 0, false, true, 5, 'M');
  $pdf->MultiCell(95, 5, 'Número De Equipo: ' . $year, 1, 'C', 0, 0, 105, 41, true, 0, false, true, 5, 'M');
  ...
  $servicio_ubicacion = "Tunel 1";
  
  $pdf->Output('Reporte_Mensual_' . $mes . '_' . $year . '_' . $servicio_ubicacion . '.pdf', 'I');
?>